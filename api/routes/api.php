...
Route::put('updateSkill/{id}', 'Api\SkillController@update');
...
Route::put('updateCountry/{id}', 'Api\CountryController@update');
...
Route::put('updateOffer/{id}', 'Api\OfferController@update');
